        ...
        <div class="mt-36 debug">
          <div class="xl:grid xl:grid-cols-12">
            <div class="xl:col-start-3 xl:col-span-8 xl:px-10 debug relative">
              ...
              <div class="absolute top-0 right-0 z-10 debug">
                <FeatureRoundel>
              ...
              <div class="absolute bottom-0 left-0 z-10 debug">
                <FeatureRoundel><img src="<SpriteIcon name="beer" class="text-cyan w-20" />
                </FeatureRoundel>
              </div>
            </div>
          </div>
