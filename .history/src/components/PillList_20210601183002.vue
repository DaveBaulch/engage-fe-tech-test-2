<template>
  <div class="md:transform md:-translate-y-pills">
    <ul role="list" class="md:grid md:grid-cols-2 md:gap-8 debug">
      ...
      <li class="mb-2.5 xl:mb-0 md:place-self-end md:mr-44">
        <BasePill text="Build customer loyalty" class="pill" />
      </li>
      <li class="mb-2.5 xl:mb-0 md:place-self-start md:ml-44">
        <BasePill text="Reservation management" class="pill" />
      </li>
      <li class="mb-2.5 xl:mb-0 md:place-self-end md:mr-32">
        <BasePill text="All-in-one solution" class="pill" />
      </li>
      <li class="mb-2.5 xl:mb-0 md:place-self-startmd:ml-32">
